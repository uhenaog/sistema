    ...
    private void btnGuardarProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarProdActionPerformed
        ...
        final SwingWorker worker = new SwingWorker() {
            ...
            protected Object doInBackground() throws Exception {
                int cantidad = 0;
                try {
                    if (datos.getColumnCount() > 9 || datos.getColumnCount() < 9) {
                    ...
                    if (datos.getRowCount() > 0) {
                        for (int i = 0; i < datos.getRowCount(); i++) {
                            sSQL = "insert into producto (cod_producto, nombre_producto, descripcion_producto,"
                                    + " unidad_producto, precio_producto, precio_compra, stock_producto, ubicacion_bodega, cod_categoriaFK) "
                                    + " values('"
