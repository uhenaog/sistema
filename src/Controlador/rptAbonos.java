 ...
 * @author oscar
 */
public class rptAbonos extends javax.swing.JInternalFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ...
            JasperReport jr = (JasperReport) JRLoader.loadObject(ReportVentasCategoria.class.getResource("/Reportes/RptAbonos.jasper"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptAbonos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
