...
//            lblTotalRegistros.setText("CANTIDAD DE REGISTROS : " + Integer.toString(funcion.totalRegistros));
    ...
    private void jTablaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMousePressed
        if (evt.getClickCount() == 2) {
            ...
            }else if(comprobarProducto == 3){
                
                Abonos.txtCod_producto.setText(cod);
                Abonos.txtNombre_producto.setText(nombre);
                Abonos.txtPrecio_producto.setText(precio);
                Abonos.txtStockDetalle.setText(stock);
                Abonos.txtSubPrecioCompra.setText(precio_compra);
                Abonos.txtCantidadProducto.setEditable(true);
                Abonos.txtCod_producto.setEditable(false);
                Abonos.txtCantidadProducto.setText("");
                Abonos.txtCantidadProducto.requestFocus();
            }
