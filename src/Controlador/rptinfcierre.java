 ...
 * @author oscar
 */
public class rptinfcierre extends javax.swing.JInternalFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ...
            JasperReport jr = (JasperReport) JRLoader.loadObject(ReportVentasCategoria.class.getResource("/Reportes/rptcierre.jasper"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptinfcierre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rptinfcierre().setVisible(true);
            }
        });
    }
