 ...
 * @author oscar
 */
public class historial_abonos extends javax.swing.JInternalFrame {

    private conexion mysql = new conexion();
    private Connection cn = mysql.conectar();
    public static int comprobarCompras;

    public historial_abonos() {
        initComponents();
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ...
            JasperReport jr = (JasperReport) JRLoader.loadObject(ReportVentasCategoria.class.getResource("/Reportes/historial_abono.jasper"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(historial_abonos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new historial_abonos().setVisible(true);
            }
        });
    }
